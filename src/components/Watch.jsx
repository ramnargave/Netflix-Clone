    ...
    <div>
        <div className="main flex flex-wrap justify-evenly items-center lg:py-20 md:py-20 py-10 px-5">
            ...
            <div className="left mb-10 lg:mb-0 md:mb-0 sm:mb-0">
                <h2 className="text-white text-center font-3xl lg:text-start md:text-start sm:text-start lg:text-5xl md:text-5xl font-bold mb-5">Watch everywhere</h2>
            ...
            {/* right  */}
            <div className="right">
               <video className="lg:w-[35em] md:w-[35em] w-[30em]" autoPlay={true} muted src="/video/v3.mp4" type="video/mp4"></video>
            </div>
        </div>
